...
%       the testImg face
    ...
    m = size(rawFaceMatrix, 2);
    meanFace = sum(rawFaceMatrix, 2) / m;
    A = rawFaceMatrix - repmat(meanFace, 1, m);
    ...
    elseif strcmp(method,'eigenface')
        ...
        testImagePCA = (testImg' * prinComponents)';
        [~, indexOfClosestMatch] = indexOfClosestColumn(weightCols, testImagePCA);
